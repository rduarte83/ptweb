...
CREATE TABLE treino (
  ...
  PRIMARY KEY (id));
CREATE TABLE treino_video (
  treinoid int4 NOT NULL,
  videoid  int4 NOT NULL,
...
ALTER TABLE artigo_video ADD CONSTRAINT FKartigo_vid171647 FOREIGN KEY (artigoid) REFERENCES artigo (id);
ALTER TABLE artigo_video ADD CONSTRAINT FKartigo_vid671645 FOREIGN KEY (videoid) REFERENCES video (id);
ALTER TABLE treino_video ADD CONSTRAINT FKtreino_vid749462 FOREIGN KEY (videoid) REFERENCES video (id);
ALTER TABLE treino_video ADD CONSTRAINT FKtreino_vid813118 FOREIGN KEY (treinoid) REFERENCES treino (id);
